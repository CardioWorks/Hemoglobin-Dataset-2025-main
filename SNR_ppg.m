...
resultsTable = cell2table(results, 'VariableNames', {'FileID', 'Channel1_SNR', 'Channel2_SNR', 'Channel3_SNR', 'Channel4_SNR'});
outputFile = 'snr_result-10.xlsx';
